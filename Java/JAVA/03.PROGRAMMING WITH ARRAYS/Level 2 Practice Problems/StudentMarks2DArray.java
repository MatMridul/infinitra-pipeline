...
public class StudentMarks2DArray {
    public static void main(String[] args) {
        ...
        // 2D Array to store marks in Physics, Chemistry, and Maths
        int[][] marks = new int[numStudents][3]; // [Physics, Chemistry, Maths]
        double[] percentages = new double[numStudents]; // Store computed percentages
        String[] grades = new String[numStudents]; // Store corresponding grades
        ...
        for (int i = 0; i < numStudents; i++) {
            ...
            for (int j = 0; j < 3; j++) {
                ...
                // Validate input: ensure marks are positive
                do {
        ...
        // Displaying the student marks, percentage, and grade
        System.out.println("\n------------------- STUDENT REPORT -------------------");
